...
/** There is HW error in calling TE driver. */
#define MBEDTLS_ERR_ECP_HW_FAILED                         -0x4A80
/** SM2 decrypt failed. */
#define MBEDTLS_ERR_ECP_SM_DECRYPT_FAILED                 -0x4A00
...
#define MBEDTLS_ECP_MAX_BITS_MIN 256
#elif defined(MBEDTLS_ECP_DP_SM2_ENABLED)
#define MBEDTLS_ECP_MAX_BITS_MIN 256
